...
<body>
	...
	<div id="main" class="wrap">
		...
		<div class="main">
			<h2>修改分类</h2>
			<div class="manage">
				<form action="CategropServlet?action=updatecateGory&epcid=${epcid}"
					method="post">
					<table class="form">
						<tr>
							<td class="field">父分类：</td>
							<td><select name="parentId" id="selec" disabled="disabled">
									<option value="0">根栏目</option>
									<c:forEach items="${list1}" var="va">
										<option value="${va.epcid}">${va.epcname}</option>
									</c:forEach>
							</select> <script type="text/javascript">
								document.getElementById("selec").value = '${typeid}';
							</script></td>
						</tr>
						<tr>
