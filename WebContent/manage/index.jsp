...
<body>
	<div id="header" class="wrap">
		...
		<div class="navbar">
			<ul class="clearfix">
				<li class="current"><a href="/Easybuy/manage/index.jsp">首页</a></li>
				<li><a href="UserServlet?action=query">用户</a></li>
				<li><a href="/Easybuy/manage/product.jsp">商品</a></li>
				<li><a href="/Easybuy/manage/order.jsp">订单</a></li>
				<li><a href="/Easybuy/manage/guestbook.jsp">留言</a></li>
				<li><a href="/Easybuy/manage/news.jsp">新闻</a></li>
			</ul>
		</div>
	</div>
	<div id="childNav">
