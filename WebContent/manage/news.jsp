...
<body>
	...
	<div id="main" class="wrap">
		<form name="listForm" action="NewsServlet?action=query" method="post">
			...
			<div class="main">
				...
				<div class="manage">
					...
					<table class="list">
						...
						<c:forEach items="${ph.list}" var="n">
							<tr>
								<td class="first w4 c">${n.id}</td>
								<td>${n.title}</td>
								<td class="w1 c"><a
									href="NewsServlet?action=updateht&id=${n.id}">修改</a> <a
									href="NewsServlet?action=delete&id=${n.id}">删除</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
